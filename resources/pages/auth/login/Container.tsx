	...
	return (
		<div className='flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8'>
			<div className='bg-light-primary dark:bg-dark-primary p-4 rounded mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
				...
				<LoginForm />
				{(discord?.active || website?.auth.register) && <div className="flex items-center mt-1">
				...
				<div className="mx-auto max-w-2xl p-1 md:rounded-lg shadow-md justify-center flex items-center">
					{website?.auth.register && <Link className="w-12 h-12 flex items-center justify-center border-2 border-light-secondary dark:border-dark-secondary duration-300 rounded-full" to="/auth/register">
						<i className="bx bxs-user-plus text-light-primary dark:text-dark-primary duration-300" style={{ fontSize: '25px' }} />
					</Link>}
					{discord?.active &&
