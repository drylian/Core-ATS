...
const SquareModel: React.FunctionComponent<SquareModelProps> = ({ title, value, active, icon }) => {
	return (
		<div className='p-1 w-full'>
			<div className='flex items-center border border-solid border-gray-300 rounded shadow-md  bg-light-secondary dark:bg-dark-secondary duration-300'>
				<div className='bg-light-primary dark:bg-dark-primary duration-300 border border-solid border-gray-300 p-5'>
