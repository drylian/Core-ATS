...
export default function MethodNotAllowed(message?: string) {
    ...
    <!DOCTYPE html>
      ...
      <head>
        ...
        <title>${config.server.title || "Core"} - Erro 405 - Method Not Allowed</title>
        ${ErrorCss(color)}
      </head>
      <body>
        <div class="blur">
          <div class="error-container">
            ...
            <h1>Erro 405</h1>
            <p>${message ? message : "A solicitação não é permitida para o recurso solicitado."}.</p>
