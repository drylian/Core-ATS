  ...
  return (
    <>
      <ContentBox title="Bem-vindo ao Nosso Site">
        <Header />
        <ShollBarController className='text-white p-4 top-5 left-5 right-5 rounded-lg shadow-md overflow-y-scroll scrollbar-hide h-screen'>
          <div className="space-y-7 p-5">
            ...
            <section className="bg-gray-900 text-white py-12 rounded-lg">
              ...
              {/* Adicione mais elementos ou conteúdo abaixo da imagem */}
            </section>
